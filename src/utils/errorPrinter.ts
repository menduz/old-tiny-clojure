...
function printErrors_(
  ...
  let fileNameToPrint = moduleName;
  ...
  const sourceAtom: Nodes.StringLiteral = parsing.getMeta(Nodes.Keyword.fromFQN('content')) as Nodes.StringLiteral;

  const source = sourceAtom.value;
